            ...
            <div className="calendar">
              <div className="hours">
                ...
                <div className="slots" style={{ height: '736px' }}>
                  <div className="block" style={{ top: '46px', height: '23.0px' }} onClick={() => toggleRunner(true)}>
                  ...
                  <div className="block task" style={{ top: '460px', height: '23.0px' }}>
      ...
      <div id="runner" style={{ display: showRunner ? 'flex' : 'none' }}>
        <div className="panel">
          ...
          <div style={{ display: 'flex', gap: '8px', marginTop: '8px' }}>
            ...
            <button className="btn" onClick={() => toggleRunner(false)}>Close</button>
          </div>
        </div>
      </div>
    </>
