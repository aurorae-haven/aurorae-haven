...
describe('HeatmapStrip Component', () => {
  test('renders 28 day cells by default', () => {
    const { container } = render(<HeatmapStrip completions={[]} vacationDates={[]} />)
  ...
  test('shows vacation days with diagonal pattern', () => {
    ...
    const { container } = render(<HeatmapStrip completions={[]} vacationDates={vacationDates} />)
  ...
  test('handles undefined vacationDates', () => {
    expect(() => render(<HeatmapStrip completions={[]} vacationDates={undefined} />)).not.toThrow()
  })

  test('supports custom number of days', () => {
    const { container } = render(<HeatmapStrip completions={[]} daysToShow={35} />)
