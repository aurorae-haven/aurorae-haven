...
- **Service Worker Registration** (auto-generated by vite-plugin-pwa):
  ...
  - Handles production and offline builds
...
└── assets/
    └── styles/                 # CSS modules
# Note: Service worker (sw.js) is auto-generated by vite-plugin-pwa during build
```
...
- `vite.config.js`: PWA configuration via vite-plugin-pwa
